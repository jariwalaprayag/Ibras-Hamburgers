...
<body bgcolor="black" text="white">
	<nav>
		...
		<ul>
            ...
            <?php
              ...
              $role=$_SESSION['role'];
              if($role=="admin"){
                echo"<li><a href='Admin.php'><font color='red'>ADMIN</a></font></li>";
	...
	<div class="back1-image">
		...
		<center><h1>Delete Burger</h1></center>
		<br><br><br><br>
		...
		<div>
			<center>
				...
				<form action="deleteburger.php" method="post">
					<div class="a1">
						Select Burger:  <select name="burger" required>
              <?php
                  $dbhandler=new PDO('mysql:host=localhost; dbname=ibras', 'root', '');
                    ...
                    {
                      $ham_name=$r['ham_name'];
                        echo"<option value='$ham_name'>".$ham_name."</option>";
                    }
              ?>
            </select><br><br><br><br>
            <input type="submit" name="message" value="Delete Burger" class="b1">
            <br><br><br><br><br>
					</div>
				</form>
			</center>
