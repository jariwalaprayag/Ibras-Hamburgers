    ...
    <div class="modal__content">
      ...
      <div align="left">
        <form action="login.php" method="post">
          &nbsp;&nbsp;Usuario:<br>
          <center><input type="text" name="userid" class="t3"></center>
          &nbsp;&nbsp;Contrasena:<br>
          <center><input type="Password" name="pwd" class="t3"></center>
    ...
    <div class="modal1__content">
      ...
      <div align="left">
        <form action="register.php" method="post">
          ...
          <center><input type="text" name="userid" class="t3"></center>
          &nbsp;&nbsp;Correo:<br>
          <center><input type="email" name="mail" class="t3"></center>
          &nbsp;&nbsp;Contrasena:<br>
          <center><input type="password" name="pwd" class="t3"></center>
          &nbsp;&nbsp;Repetir Contrasena:<br>
          <center><input type="password" name="repwd" class="t3"></center>
          &nbsp;&nbsp;Direccion:<br>
          <center><input type="text" name="address" class="t3"></center>
          <br><hr><br>
          <div style="text-align: right; padding-right: 10px;">
